...
exports.stockRoutes.patch("/partial/:stockId", [(0, express_validator_1.check)("quantity").isInt({ min: 0, max: 20 }), (0, express_validator_1.check)("inUse").isBoolean()], stock_1.updateStockPartial);
